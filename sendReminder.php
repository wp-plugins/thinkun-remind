...
<div class="wrap">	
	...
	<div style="float:right;">
		...
		<p style="padding-top:5px;"><a class="link-button" style="padding-right:12px;" href="<?php echo get_bloginfo('url')?>/wp-content/plugins/thinkun-remind/exportData.php">Export logs as CSV</a></p>
	</div>
