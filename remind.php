...
/*-----Function is used to create admin menu Start-----*/
	function addMenu() { 
		add_menu_page(
			...
			get_bloginfo('url')."/wp-content/plugins/thinkunremind/image/email-icon.gif", // icon url
			"30" // menu position 
		); 		
	}
	...
	function sendreminder()
	{
		...
		/*-----Used to send email Start-----*/
			...
			{	
				...
				echo "<script>location = '".get_bloginfo('url')."/wp-admin/admin.php?page=thinkunremind/remind.php&msg=".$message."';</script>";
